...
class LollmsClient():
    ...
    def generate_completion(self, prompt, host_address, model_name=None, n_predict=1024, stream=False, temperature=0.1, top_k=50, top_p=0.95, repeat_penalty=0.8, repeat_last_n=40, seed=None, n_threads=8):
        url = f"{host_address}/lollms_generate"
