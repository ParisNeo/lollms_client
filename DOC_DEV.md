...
```
📁 lollms_client/
├─ 📁 ai_documentation/         # Markdown files generated by AI documentation tools
├─ 📁 dist/                     # Build artifacts
├─ 📁 examples/                 # Example scripts demonstrating client usage
│  ├─ 📁 article_summary/
│  ├─ 📁 deep_analyze/
│  ├─ 📁 function_calling_with_local_custom_mcp.py # Shows custom MCP tools
│  ├─ 📁 local_mcp.py                              # Shows default MCP tools
│  ├─ 📁 generate_and_speak/
│  └─ ... (other examples)
...
│  ├─ 📄 lollms_core.py          # LollmsClient class, main orchestrator (includes generate_with_mcp, summarize, etc.)
