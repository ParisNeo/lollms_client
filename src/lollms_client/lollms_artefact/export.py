...
"""
    ...
    def _export_as_zip(self, art: Dict[str, Any]) -> bytes:
        ...
        with zipfile.ZipFile(buffer, "w", zipfile.ZIP_DEFLATED) as z:
            ...
            # 🛑 .LAM INVARIANT: only the physical twins on disk are bundled here.
            # Their logical twins (.lam) live exclusively in .versions/{id}/ and are
            # NEVER written over, or in place of, a physical artefact.
            try:
                from lollms_client.app.Discussion_UI.server import APP_WORKSPACE_DIR
