...
"""
    ...
    def _build_artefact_instructions(self) -> str:
        ...
        lines = [
            ...
            "",
            "=== SUB-AGENT DELEGATION (tool_spawn_sub_agent) ===",
            "To delegate complex, heavy, or self-contained tasks to a focused sub-agent, call `tool_spawn_sub_agent`.",
            "Define the specialization dynamically by providing a custom `system_prompt` (e.g. 'You are an expert Python data engineer...').",
            "The sub-agent will execute in a focused sandbox, save all generated files directly to disk, and return a verified report.",
            "",
