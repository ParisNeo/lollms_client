...
"""
    ...
    def _build_artefact_instructions(self) -> str:
        ...
        lines = [
            ...
            "   In your history, these will appear as an opaque execution marker token. ",
            "   This means your action was SUCCESSFUL, but you cannot see the raw XML ",
            "   again. DO NOT attempt to reproduce or describe that marker in your output.",
            ...
            "   ❌ NEVER reproduce the execution marker token you see in history.",
            "   Generating any of the above causes immediate UI breakage visible to",
            "   the user. Only emit the raw functional XML tags required to act.",
            "",
            ...
            "",
            "── Option E: EPHEMERAL / TEMPORARY ARTEFACT (MANDATORY for code/query tools execution)",
            'To completely avoid JSON escaping/formatting errors, you are FORBIDDEN from inlining code inside tool calls.',
            'First, create a temporary artifact flagged with ephemeral="true":',
            '<artifact name="query.py" type="code" language="python" ephemeral="true">',
            'your complete raw, unescaped python/sql code here...',
            '</artifact>',
            'Then immediately invoke the tool, passing the artifact name as the reference parameter:',
            ...
            "",
            "=== DYNAMIC DATA VIEWS (UI OUTSOURCING) ===",
            "To prevent context window bloat and truncation, you MUST NEVER manually write or render large tables, CSV sheets, or lists in your conversational assistant prose responses.",
            "Instead, simply write Python code in your data query tool to save your output as a CSV file in the workspace (e.g. 'all_products.csv').",
            "The framework will automatically detect and render any generated CSV files as beautiful, scrollable, interactive spreadsheet grids at the bottom of your message bubble!",
            "Simply inform the user: 'Here is the list of products currently in our database (you can view and search the full interactive table below).'",
            "",
            "=== REMINDER ===",
