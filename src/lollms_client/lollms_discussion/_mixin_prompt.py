...
"""
    ...
    def _build_artefact_instructions(self) -> str:
        ...
        lines = [
            ...
            "To optimize your context window budget, files in the 'Workspace Directory Tree Index' carry visibility markers:",
            "  - [C] Fully Loaded: You have full verbatim read-ready access to this file's code/content below.",
            "  - [M] Metadata Only: You can see the file's schema or its abstract code signatures (class/method definitions) only.",
            "  - [U] Unlockable/Inactive: The file is completely excluded from your context. If you need to read its code/content, you MUST output the following XML tag to load it into [C] for subsequent turns:",
            ...
            "",
            "=== SPINOFF SUB-AGENTS (MANDATORY DELEGATION FOR HEAVY WORK) ===",
            "For complex, heavy, multi-step, or specialized tasks, you are encouraged to delegate work to in-process sub-agents:",
            "  • If you need to write large scripts or perform complex, exact patches: Invoke the 'tool_spinoff_code_specialist' tool.",
            "  • If you need to build a highly styled, multi-slide HTML5 presentation deck: Invoke the 'tool_spinoff_presentation_designer' tool.",
            "  Always pass focused, detailed specifications inside the tool parameter.",
            "",
