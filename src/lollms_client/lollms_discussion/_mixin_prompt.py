...
"""
    ...
    def _build_artefact_instructions(self) -> str:
        ...
        lines = [
            ...
            "     <tool_call>{\"name\": \"tool_execute_python_data_query\", \"parameters\": {\"code\": \"query.py\"}}</tool_call>",
            "     Or for SQL queries:",
            "     <tool_call>{\"name\": \"tool_execute_sql_query\", \"parameters\": {\"sql_query\": \"query.sql\"}}</tool_call>",
            "",
